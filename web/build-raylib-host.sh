...
EXPORTS='_cf_init_window,_cf_clear_background,_cf_draw_rectangle,_cf_draw_line_ex,_cf_draw_text,_cf_check_collision_recs,_cf_check_collision_point_rec,_cf_load_texture,_cf_unload_texture,_cf_draw_texture,_cf_draw_poly,_cf_draw_poly_lines,_cf_draw_poly_lines_ex,_BeginDrawing,_EndDrawing,_CloseWindow,_SetTargetFPS,_WindowShouldClose,_IsKeyPressed,_IsKeyDown,_IsKeyUp,_IsKeyPressed,_IsMouseButtonPressed,_IsMouseButtonDown,_IsMouseButtonReleased,_IsMouseButtonUp,_IsGamepadButtonPressed,_GetTouchX,_GetTouchY,_GetTouchPosition,_GetTouchPointId,_GetTouchPointCount,_SetGesturesEnabled,_IsGestureDetected,_GetGestureDetected,_GetGestureHoldDuration,_GetGestureDragVector,_GetGestureDragAngle,_GetGesturePinchVector,_GetGesturePinchAngle,_GetFrameTime,_InitAudioDevice,_CloseAudioDevice,_IsAudioDeviceReady,_LoadWave,_LoadWaveFromMemory,_IsWaveValid,_LoadSound,_LoadSoundFromWave,_LoadSoundAlias,_IsSoundValid,_UpdateSound,_UnloadWave,_UnloadSound,_UnloadSoundAlias,_ExportWave,_ExportWaveAsCode,_PlaySound,_StopSound,_PauseSound,_ResumeSound,_IsSoundPlaying,_SetSoundVolume,_SetSoundPitch,_SetSoundPan,_WaveCopy,_WaveCrop,_WaveFormat,_LoadWaveSamples,_UnloadWaveSamples,_SetAudioStreamBufferSizeDefault,_cf_load_sound,_cf_play_sound,_cf_stop_sound,_cf_pause_sound,_cf_resume_sound,_cf_is_sound_playing,_cf_set_sound_volume,_cf_set_sound_pitch,_cf_set_sound_pan,_cf_unload_sound,_cf_is_sound_valid,_cf_load_music_stream,_cf_load_music_stream_from_memory,_cf_is_music_valid,_cf_unload_music_stream,_cf_play_music_stream,_cf_is_music_playing,_cf_update_music_stream,_cf_stop_music_stream,_cf_pause_music_stream,_cf_resume_music_stream,_cf_seek_music_stream,_cf_set_music_volume,_cf_set_music_pitch,_cf_set_music_pan,_cf_get_music_time_length,_cf_get_music_time_played,_MeasureText,_GetMouseX,_SetRandomSeed,_GetRandomValue,_GetMouseY,_malloc,_free'
